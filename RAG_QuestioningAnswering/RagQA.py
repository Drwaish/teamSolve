...
class Rag:
    def __init__(self):
        ...
        self.emb = Embeddings()
        self.retriever = self.emb.store_vectordb('RagQADoc.pdf')  # Create presisten DB
        self.retriever = self.emb.update_db('Resume_MirzaZainAliNasir.pdf')  # Update DB
        self.llm = self.emb.llm_initialization()
